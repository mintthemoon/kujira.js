...
export const castPool = (address, res, margin)=>({
        ...
        owner: res.owner,
        denoms: [
            Denom.from(res.denoms[0]),
            Denom.from(res.denoms[1])
        ],
