...
export function setupWasmExtensionExtended(base) {
    ...
    return {
        wasm: _object_spread_props(_object_spread({}, setupWasmExtension(base).wasm), {
