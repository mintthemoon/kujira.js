...
const castConfig = (json)=>({
        denoms: [
            Denom.from(typeof json.denoms[0] === "string" ? json.denoms[0] : json.denoms[0].native),
            Denom.from(typeof json.denoms[1] === "string" ? json.denoms[1] : json.denoms[1].native)
        ],
...
export const compile = (network)=>(a, v)=>{
        ...
        return _object_spread_props(_object_spread({}, a), {
            [v.address]: _object_spread_props(_object_spread({
                ...
                pool: (_contracts_network_bow_reverse_find = contracts[network].bow// Reverse as the laterly created contracts are more likely to be correct
                .reverse()// @ts-ignore
                ...
                calc: ((_contracts_network_calc_ = contracts[network].calc[0]) === null || _contracts_network_calc_ === void 0 ? void 0 : _contracts_network_calc_.pairs.find((x)=>x.denoms[0] === config.denoms[0].reference && x.denoms[1] === config.denoms[1].reference)) ? (_contracts_network_calc_1 = contracts[network].calc[0]) === null || _contracts_network_calc_1 === void 0 ? void 0 : _contracts_network_calc_1.address : undefined,
                margin: margin ? _object_spread({
                    address: margin.address
                }, usk.castConfig(margin.config.market)) : undefined
            })
        });
    };
export const PAIRS = {
