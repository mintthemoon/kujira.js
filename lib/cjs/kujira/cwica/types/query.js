...
_export(exports, {
    ...
    QueryInterchainAccountRequest: function() {
        return QueryInterchainAccountRequest;
    },
    QueryInterchainAccountResponse: function() {
...
const QueryInterchainAccountRequest = {
    ...
    fromJSON (object) {
        ...
        if ((0, _helpers.isSet)(object.owner)) obj.owner = String(object.owner);
        if ((0, _helpers.isSet)(object.connectionId)) obj.connectionId = String(object.connectionId);
        if ((0, _helpers.isSet)(object.accountId)) obj.accountId = String(object.accountId);
        return obj;
    },
    toJSON (message) {
        const obj = {};
...
const QueryInterchainAccountResponse = {
    ...
    fromJSON (object) {
        ...
        if ((0, _helpers.isSet)(object.interchainAccountAddress)) obj.interchainAccountAddress = String(object.interchainAccountAddress);
        return obj;
    },
    toJSON (message) {
        const obj = {};
...
class QueryClientImpl {
    InterchainAccount(request) {
        ...
        return promise.then((data)=>QueryInterchainAccountResponse.decode(new _binary.BinaryReader(data)));
    }
    constructor(rpc){
