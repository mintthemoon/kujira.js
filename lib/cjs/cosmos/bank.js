...
Object.defineProperty(exports, "setupBankExtensionExtended", {
    enumerable: true,
    get: function() {
        return setupBankExtensionExtended;
    }
});
const _stargate = require("@cosmjs/stargate");
const _query = require("cosmjs-types/cosmos/bank/v1beta1/query");
...
function setupBankExtensionExtended(base) {
    ...
    return {
        bank: _object_spread_props(_object_spread({}, (0, _stargate.setupBankExtension)(base).bank), {
